...
namespace ECM.Walkthrough.CustomInput
{
    ...
    public class MyCharacterController : BaseCharacterController, ICameraPursued
    {
        ...
        public async Task Park(Vector3 position)
        {
            Vector3 fixedEulerAngles = new Vector3(0, -90, 0);
            ...
            var animRotation = movement.transform.DORotate(fixedEulerAngles, 0.5f, RotateMode.Fast);
