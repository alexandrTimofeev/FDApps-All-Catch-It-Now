...
public sealed partial class CameraFollower : MonoBehaviour, IService
{
    ...
    {
        while (this != null && gameObject != null && Vector3.Distance(eulerAngle, _settings.EulerAngle) > 0.1f)
        {
            ...
            if (this != null) transform.localEulerAngles = CameraAngle;
    ...
    {
        while (this != null && gameObject != null && Vector3.Distance(spaces, _settings.Spaces) > 0.1f)
        {
            if (this == null || gameObject == null) break;

            _settings.Spaces = Vector3.Lerp(_settings.Spaces, spaces, FollowSpeed * Time.deltaTime);
            if (this != null) transform.position = Vector3.Lerp(transform.position, CameraRelativePosition, FollowSpeed * Time.deltaTime);
